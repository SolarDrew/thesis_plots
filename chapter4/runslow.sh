...
python plotres_v_models.py 1 94 > testvmod-1-94.txt
python plotres_v_models.py 1 131 > testvmod-1-131.txt
python plotres_v_models.py 1 171 > testvmod-1-171.txt
python plotres_v_models.py 1 193 > testvmod-1-193.txt
python plotres_v_models.py 1 211 > testvmod-1-211.txt
python plotres_v_models.py 1 335 > testvmod-1-335.txt
python plotres_v_models.py 1 three > testvmod-1-t.txt
#python plotres_v_models.py 1 all > testvmod-1-a.txt
#python plotres_v_models.py 3 void > testvmod-3.txt
